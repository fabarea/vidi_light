...
use Fab\VidiLight\Grid\ColumnRendererInterface;
use Fab\VidiLight\Module\ConfigurablePart;
use Fab\VidiLight\Module\ModulePreferences;
use TYPO3\CMS\Core\Localization\LanguageService;
use TYPO3\CMS\Core\Utility\GeneralUtility;
use Fab\VidiLight\Exception\InvalidKeyInArrayException;
use Fab\VidiLight\Facet\StandardFacet;
use Fab\VidiLight\Facet\FacetInterface;
            ...
            if (!empty($additionalFields)) {
                ...
                foreach ($additionalFields as $additionalField) {
                    ...
                    if ($fieldType === FieldType::DATE) {
                        $fields[$additionalField]['format'] = 'Fab\VidiLight\Formatter\Date';
                    } elseif ($fieldType === FieldType::DATETIME) {
                        $fields[$additionalField]['format'] = 'Fab\VidiLight\Formatter\Datetime';
                    }
                }
